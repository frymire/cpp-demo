...
// Adapted from Instrumentor code from TheCherno.
// See here: https://gist.github.com/TheCherno/31f135eea6ee729ab5f26a6908eb3a5e
// And here: https://www.youtube.com/watch?v=xlAH4dbMVnU&list=WL&index=16
...
//public:
//  Timer(const char* name): m_name(name), m_start_time(steady_clock::now()) {}
//  ~Timer() {
//    duration<float> duration = steady_clock::now() - m_start_time;
//    cout << m_name << ": " << duration.count() << " s" << endl;
//  }
//};
...
public:
  ...
  void WriteProfile(const ProfileResult& result) {
    ...
    m_output_stream.flush(); // flush incrementally to retain data after a crash.
  }
...
public:
  ...
  void Stop() {
    ...
    // This uses a trick with the hash function to extract the thread ID, which is hard otherwise.
