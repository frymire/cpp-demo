...
// These would be linker errors, due to the duplicate declarations in main.
//int global = 5; 
//void DuplicateFunction() {}

// This was already declared in main, but not initialized. Because it 
...
// Redefining these here is okay, despite being declared in main.cpp.
// Declaring these as static means that the linker doesn't look outside of 
// this file. This is beneficial for limiting the scope for variables and 
// functions that would otherwise be global.
static int s_my_static_int = 10;
static void FunctionWithStatic() {}
